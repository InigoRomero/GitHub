				...
				<table>
					...
					if(isset($error2)){
						echo form_open('Tiendamerch/registrar');		
							...
							echo '</td>';echo '</tr>';
							echo '<tr><td colspan="2"><span class="error">';if(isset($errornameC)) echo $errornameC; if(isset($erruserLong)) echo $erruserLong; echo '</span></td></tr><br>'; //errores
							echo '<tr>';echo '<td>';
							...
							echo '</td>';echo '</tr>';
							echo '<tr><td colspan="2"><span class="error">';if(isset($errCorreoMal)) echo $errCorreoMal;  echo '</span></td></tr><br>'; //errores
							echo '<tr>';echo '<td>';
